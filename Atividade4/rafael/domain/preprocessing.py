...
def parse_dataset(path: str, separator: Separator, has_header=False):
    ...
    return Dataset(data, columns_count, rows_count, missing_values)


def fill_missing_values(dataset: Dataset, fill_mode: FillMode):
    mean_cols = dict()
    mode_cols = dict()
